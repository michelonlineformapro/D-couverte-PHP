...
session_start();
$question1 = array(
    array("question" => "A quelle langage php est il comparé ? ",
        "reponses1" => "Perl",
        "reponses2" => "Boo",
        "reponses3" => "Python",
        "reponses4" => "Java",
...
<div class="container-fluid center-container-quizz">
    ...
    foreach ($question1 as $value) {
        ...
        <p class="alert alert-success text-center">Question : 5 / 5 </p>
        ...
        if(isset($_POST['btn-valide-1'])){
            ...
            if(isset($_POST['reponses'])){
                ...
                if($reponse === $value['reponses3']){
                    ...
                    echo "<a href='final.php' class='btn btn-success mt-3'>Question suivante</a>";
                    ...
                    echo "<p class='mt-3 alert alert-warning'>SCORE = " . $_SESSION['score']." / 5</p>";
                    $_SESSION['score'] += 0;
                    echo "<a href='final.php' class='btn btn-outline-dark mt-3'>Question suivante</a>";
