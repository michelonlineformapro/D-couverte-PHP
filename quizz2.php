...
<div class="container-fluid center-container-quizz">
    ...
    foreach ($question1 as $value) {
        ...
        <p class="alert alert-success text-center">Question : 2 / 5 </p>
        ...
        if(isset($_POST['btn-valide-1'])){
            ...
            if(isset($_POST['reponses'])){
                ...
                //var_dump($reponse);
                if($reponse === $value['reponses1']){
                    echo "<p class='alert alert-success text-center mt-3'>BONNE REPONSE = " .$value['reponses1']."</p>";
                    $_SESSION['score'] += 1;
                    ...
                    echo "<p class='alert alert-danger text-center mt-3'>ERREUR : BONNE REPONSE etait = " .$value['reponses1']."</p>";
                    echo "<p class='mt-3 alert alert-warning'>SCORE = " . $_SESSION['score']." / 5</p>";
                    $_SESSION['score'] += 0;
                    echo "<a href='quizz3.php' class='btn btn-outline-dark mt-3'>Question suivante</a>";
