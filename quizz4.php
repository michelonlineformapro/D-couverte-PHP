...
session_start();
$question1 = array(
    array("question" => "Que signifie PHP ? ",
        "reponses1" => "Personal Home Page",
        "reponses2" => "Partage Hypertext Protocol",
        "reponses3" => "Pour Homme Polyvalent",
        "reponses4" => "PHP Hypertext Processor",
    )
);
?>
<!doctype html>
...
<div class="container-fluid center-container-quizz">
    ...
    foreach ($question1 as $value) {
        ...
        <p class="alert alert-success text-center">Question : 4 / 5 </p>
        ...
        if(isset($_POST['btn-valide-1'])){
            ...
            if(isset($_POST['reponses'])){
                ...
                //var_dump($reponse);
                if($reponse === $value['reponses4']){
                    echo "<p class='alert alert-success text-center mt-3'>BONNE REPONSE = " .$value['reponses4']."</p>";
                    $_SESSION['score'] += 1;
                    echo "<p class='mt-3 alert alert-warning'>SCORE = " . $_SESSION['score']." / 5 </p>";
                    echo "<a href='quizz5.php' class='btn btn-success mt-3'>Question suivante</a>";
                    ...
                    echo "<p class='alert alert-danger text-center mt-3'>ERREUR : BONNE REPONSE = " .$value['reponses4']."</p>";
                    echo "<p class='mt-3 alert alert-warning'>SCORE = " . $_SESSION['score']." / 5</p>";
                    $_SESSION['score'] += 0;
                    echo "<a href='quizz5.php' class='btn btn-outline-dark mt-3'>Question suivante</a>";
